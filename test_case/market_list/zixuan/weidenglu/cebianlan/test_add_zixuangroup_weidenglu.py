...
#
#
# @pytest.mark.parametrize("caseid,tab_name,tab_num", [("TC_自选分组抽屉_全部分组_未登录新建自选分组:2196839", "全部", "全部(8)"),
#                                                      ("TC_自选分组抽屉_自选分组_未登录新建自选分组:2196727", "自选分组", "自选分组(0)")])
# def test_groupall_add_zixuangroup_weidenglu(poco, caseid, tab_name, tab_num):
#     """
#     用例名称
#     2196839
#     TC_自选分组抽屉_全部分组_未登录新建自选分组
#     2196727
#     TC_自选分组抽屉_自选分组_未登录新建自选分组
#
#     """
