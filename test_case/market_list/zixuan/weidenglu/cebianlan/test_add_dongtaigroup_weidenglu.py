...
#
#
# @pytest.mark.parametrize("caseid,tab_name,tab_num", [("TC_自选分组抽屉_全部分组_未登录新建动态分组:2196846", "全部", "全部(8)"),
#                                                      ("TC_自选分组抽屉_自选分组_未登录新建动态分组:2197781", "自选分组", "自选分组(0)"),
#                                                      ("TC_自选分组抽屉_动态分组_未登录新建动态分组:2196725", "动态分组", "动态分组(8)")])
# def test_groupall_add_dongtaigroup_weidenglu(poco, caseid, tab_name, tab_num):
#     """
#     用例名称
#     TC_自选分组抽屉_全部分组_未登录新建动态分组
#     用例id
#     2196846
#       TC_自选分组抽屉_自选分组_未登录新建动态分组:2197781
#     TC_自选分组抽屉_动态分组_未登录新建动态分组:2196725
#     """
...
#     poco("com.hexin.plat.android:id/create_btn").click()
#     poco("com.hexin.plat.android:id/create_dynamic_group_text").click()
#
